          ...
          <tbody class="bg-white">
            <tr>
              ...
              <td class="text-sm font-medium leading-5 text-center whitespace-no-wrap border-b border-gray-200 ">
                <a href="article/edit/{{$article->id}}" class="text-indigo-600 hover:text-indigo-900">
              ...
              <td class="text-sm font-medium leading-5 text-center whitespace-no-wrap border-b border-gray-200 ">
                <a href="article/show/{{$article->id}}" class="text-gray-600 hover:text-gray-900">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              ...
              <td class="text-sm font-medium leading-5 whitespace-no-wrap border-b border-gray-200 ">
                ...
                <!-- <a href="/artikel/delete/{{$article->id}}"> --><button type="submit"><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-red-600 hover:text-red-800"
