            ...
            <form method="POST" action="{{ route('admin.portfolio.update', $portfolio->id)}}" enctype="multipart/form-data">
              ...
              <div>
                ...
                <input
                  ...
                  type="text" name="title" placeholder="180" value="{{$portfolio->title}}" />
              </div>
              ...
              <div>
                ...
                <input
                  class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                  type="text" name="header" placeholder="180" value="{{$portfolio->header}}" />
              </div>
              ...
              <div class="mt-4">
                ...
                <textarea name="body"
                  class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                  rows="4" placeholder="400">{{html_entity_decode($portfolio->body)}}</textarea>
              </div>
              ...
              <div>
                ...
                <input
                  class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                  type="text" name="footer" placeholder="180" value="{{$portfolio->footer}}" />
              </div>
