    ...
    <div class="grid md:grid-cols-2 gap-x-6 xl:gap-x-12 items-center mb-12">
      <div class="mb-6 md:mb-0">
        <div
          ...
          <img src="{{ asset('img/portfolio/'.$portfolios->image_url) }}"
      ...
      <div class="mb-6 md:mb-0">
        <h3 class="text-2xl font-bold mb-3">{{ $portfolios->title }}</h3>
        ...
        <p class="text-gray-500 mb-6">
          <small>Published <u>{{ $portfolios->created_at }}</u>
            </small>
        </p>
